...
<head>
    ...
    <title>Búsqueda de Consulta Médica</title>
...
// Obtener el ID de la consulta del formulario de búsqueda
$consultaid = $_POST['consultaid'];

// Preparar la consulta de búsqueda
$query_buscar = "SELECT * FROM Enf_Consulta_Medica WHERE consultaid = :consultaid";
$stid_buscar = oci_parse($conn, $query_buscar);
oci_bind_by_name($stid_buscar, ":consultaid", $consultaid);
