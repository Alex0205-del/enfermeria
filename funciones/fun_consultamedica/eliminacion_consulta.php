...
// Obtener el consultaid para eliminar
$consultaid_eliminar = $_POST['consultaid_eliminar'];

// Preparar la consulta de eliminación en la tabla Enf_Consulta_Medica
$query_eliminar = "DELETE FROM Enf_Consulta_Medica WHERE consultaid = :consultaid_eliminar";
$stid_eliminar = oci_parse($conn, $query_eliminar);
oci_bind_by_name($stid_eliminar, ":consultaid_eliminar", $consultaid_eliminar);
...
if ($resultado_eliminar) {
    echo "Datos eliminados correctamente de la tabla Enf_Consulta_Medica.";
