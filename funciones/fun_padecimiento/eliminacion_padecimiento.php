...
// Obtener el padecimientoID a eliminar
$padecimientoID_eliminar = $_POST['padecimientoID_eliminar'];

// Preparar la consulta de eliminación
$query_eliminar = "DELETE FROM Enf_Padecimiento WHERE padecimientoID = :padecimientoID_eliminar";
$stid_eliminar = oci_parse($conn, $query_eliminar);
oci_bind_by_name($stid_eliminar, ":padecimientoID_eliminar", $padecimientoID_eliminar);
...
if ($resultado_eliminar) {
    echo "Datos eliminados correctamente de la tabla Enf_Padecimiento.";
