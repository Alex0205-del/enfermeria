...
// Obtener el nombre del medicamento del formulario de búsqueda
$nombreMedicamento = $_POST['nombreMedicamento'];

// Preparar la consulta de búsqueda
$query_buscar = "SELECT * FROM Enf_Medicamento WHERE nombre = :nombreMedicamento";
$stid_buscar = oci_parse($conn, $query_buscar);
oci_bind_by_name($stid_buscar, ":nombreMedicamento", $nombreMedicamento);
...
echo "<table border='1'>";
echo "<tr><th>medicamentoID</th><th>nombre</th><th>marca</th><th>fecha_cad</th><th>dosis</th></tr>";
