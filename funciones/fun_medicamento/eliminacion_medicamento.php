...
// Obtener el medicamentoID para eliminar
$medicamentoID_eliminar = $_POST['medicamentoID_eliminar'];

// Preparar la consulta de eliminación
$query_eliminar = "DELETE FROM Enf_Medicamento WHERE medicamentoID = :medicamentoID_eliminar";
$stid_eliminar = oci_parse($conn, $query_eliminar);
oci_bind_by_name($stid_eliminar, ":medicamentoID_eliminar", $medicamentoID_eliminar);
...
if ($resultado_eliminar) {
    echo "Datos eliminados correctamente de la tabla Enf_Medicamento.";
